...
from simcampus.simulation_types import GroupFrequency, GroupParameters, Stay, Transitions


def read_data_from_files(inputdir: Union[str, PosixPath]) -> tuple[GroupFrequency, GroupParameters, Transitions, Stay]:
    ...
    return group_freq, group_param, transitions, stay_param
